...
import PaletteBuilder from './PaletteBuilder/PaletteBuilder';
import PaletteAudit from './PaletteAudit/PaletteAudit';
import AutoFix from './AutoFix/AutoFix';
  ...
  return (
    <div className="atk">
      ...
      <div className="atk__panel">
        {tool === 'checker' && (
          <ContrastChecker initialForeground={fixPair.fg} initialBackground={fixPair.bg} />
        )}
        {tool === 'builder' && <PaletteBuilder prefillColors={incomingColors} />}
